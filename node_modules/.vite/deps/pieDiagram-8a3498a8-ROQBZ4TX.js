...
// node_modules/mermaid/dist/pieDiagram-8a3498a8.js
...
var parser$1 = parser;
var DEFAULT_PIE_CONFIG = defaultConfig$2.pie;
var DEFAULT_PIE_DB = {
  sections: {},
  showData: false,
...
var getConfig2 = () => structuredClone(config);
var clear2 = () => {
  sections = structuredClone(DEFAULT_PIE_DB.sections);
  showData = DEFAULT_PIE_DB.showData;
  clear();
};
var addSection = (label, value) => {
  label = sanitizeText$2(label, getConfig());
  if (sections[label] === void 0) {
    sections[label] = value;
    log$1.debug(`added new section: ${label}, with value: ${value}`);
  }
};
var getSections = () => sections;
var cleanupValue = (value) => {
  if (value.substring(0, 1) === ":") {
    value = value.substring(1).trim();
  }
  return Number(value.trim());
};
var setShowData = (toggle) => {
  showData = toggle;
};
var getShowData = () => showData;
var db = {
...
//# sourceMappingURL=pieDiagram-8a3498a8-ROQBZ4TX.js.map
