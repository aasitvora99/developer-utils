...
// node_modules/mermaid/dist/styles-6aaf32cf.js
var parser = function() {
...
var docTranslator = (parent, node, first) => {
...
var addState = function(id, type = DEFAULT_STATE_TYPE, doc = null, descr = null, note = null, classes2 = null, styles2 = null, textStyles = null) {
...
var clear2 = function(saveCommon) {
  documents = {
    root: newDoc()
  };
...
function addRelationObjs(item1, item2, relationTitle) {
  ...
  currentDocument.relations.push({
    id1,
    id2,
    relationTitle: common$1.sanitizeText(relationTitle, getConfig())
  });
}
var addRelation = function(item1, item2, title) {
  if (typeof item1 === "object") {
    ...
    currentDocument.relations.push({
      id1,
      id2,
      title: common$1.sanitizeText(title, getConfig())
    });
  }
};
var addDescription = function(id, descr) {
  const theState = currentDocument.states[id];
  const _descr = descr.startsWith(":") ? descr.replace(":", "").trim() : descr;
  theState.descriptions.push(common$1.sanitizeText(_descr, getConfig()));
};
...
var addStyleClass = function(id, styleAttributes = "") {
...
var setCssClass = function(itemIds, cssClassName) {
...
var setStyle = function(itemId, styleText) {
  const item = getState(itemId);
  if (item !== void 0) {
    item.textStyles.push(styleText);
  }
};
var setTextStyle = function(itemId, cssClassName) {
  const item = getState(itemId);
  if (item !== void 0) {
...
//# sourceMappingURL=chunk-CONBSJIJ.js.map
