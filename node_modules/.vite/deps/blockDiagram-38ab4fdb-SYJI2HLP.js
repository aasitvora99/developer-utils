import {
  ...
  positionEdgeLabel,
  positionNode
} from "./chunk-TOJPXFKD.js";
import "./chunk-XICJE7ZF.js";
import {
  Graph,
  clone_default
} from "./chunk-7A6ZWAMI.js";
import {
  Tableau10_default,
  channel_default,
  clear,
...
// node_modules/mermaid/dist/blockDiagram-38ab4fdb.js
...
var classes = {};
var sanitizeText = (txt) => common$1.sanitizeText(txt, config);
...
var addStyle2Node = function(id, styles = "") {
...
var populateBlockDatabase = (_blockList, parent) => {
  ...
  for (const block of blockList) {
    ...
    if (block.type === "column-setting") {
      ...
      if (block.type === "space") {
        ...
        for (let j = 0; j < w; j++) {
          const newBlock2 = clone_default(block);
...
var setHierarchy = (block) => {
  rootBlock.children = block;
  populateBlockDatabase(block, rootBlock);
  blocks = rootBlock.children;
};
var getColumns = (blockId) => {
...
var getLogger = () => console;
var getClasses$1 = function() {
  return classes;
};
var db = {
...
var padding = ((_b = (_a = getConfig()) == null ? void 0 : _a.block) == null ? void 0 : _b.padding) || 8;
...
//# sourceMappingURL=blockDiagram-38ab4fdb-SYJI2HLP.js.map
