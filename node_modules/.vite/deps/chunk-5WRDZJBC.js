...
function merge_default(context) {
  ...
  for (var groups0 = this._groups, groups1 = selection2._groups, m0 = groups0.length, m1 = groups1.length, m = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m; ++j) {
    for (var group0 = groups0[j], group1 = groups1[j], n = group0.length, merge4 = merges[j] = new Array(n), node2, i = 0; i < n; ++i) {
...
function each_default(callback) {
  for (var groups2 = this._groups, j = 0, m = groups2.length; j < m; ++j) {
    for (var group2 = groups2[j], i = 0, n = group2.length, node2; i < n; ++i) {
      if (node2 = group2[i]) callback.call(node2, node2.__data__, i, group2);
    }
  }
  return this;
}
...
function transform(node2) {
  while (!node2.__zoom) if (!(node2 = node2.parentNode)) return identity5;
  return node2.__zoom;
}

// node_modules/mermaid/node_modules/dompurify/dist/purify.es.mjs
var {
  entries,
  setPrototypeOf,
  isFrozen,
...
function cleanArray(array4) {
  for (let index2 = 0; index2 < array4.length; index2++) {
    const isPropertyExist = objectHasOwnProperty(array4, index2);
    if (!isPropertyExist) {
      array4[index2] = null;
    }
  }
...
var identity_default6 = identity6;
...
var constant_default12 = constant2;
...
var baseSetToString = !defineProperty_default ? identity_default6 : function(func, string) {
  return defineProperty_default(func, "toString", {
    "configurable": true,
    "enumerable": false,
    "value": constant_default12(string),
    "writable": true
  });
};
...
function baseRest(func, start2) {
  return setToString_default(overRest_default(func, start2, identity_default6), func + "");
}
          ...
          default:
            ...
            if (character2 === 123)
              if (offset === 0)
                ...
                if (offset) parse(value, reference, reference, rule && append2(ruleset(value, reference, reference, 0, 0, rules, points, type3, rules, props = [], length2, children2), children2), rules, children2, length2, points, rule ? props : children2);
                else parse(characters2, reference, reference, reference, [""], children2, 0, points, children2);
              }
        }
...
var renderKatex = async (text2, config2) => {
  ...
  const { default: katex } = await import("./katex-A5ZTM5XT.js");
...
`,
    ...
    log$1.error(
      `ERROR: ${error.message} - Unable to parse directive type: '${type22}' based on the text: '${text2}'`
    );
...
var loader$m = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-3d4e48cf-UDTXNWHK.js");
...
var loader$l = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-66a62f08-CPTGFTOX.js");
...
var loader$k = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-96b9c2cf-IG6IRAQS.js");
...
var loader$j = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-9861fffd-T5PHRABU.js");
...
var loader$i = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-72cf32ee-SGM5QF52.js");
...
var loader$h = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-c361ad54-APFJRLII.js");
...
var loader$g = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-f8f76790-VI7RAEAG.js");
...
var loader$f = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-8a3498a8-ROQBZ4TX.js");
...
var loader$e = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-120e2f19-YFQVPZEF.js");
...
var loader$d = async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-e933f94c-QWDUQFXX.js");
...
var loader$c = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-deff3bca-BBMSLP5D.js");
...
var loader$b = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-704730f1-6GE4VD46.js");
...
var loader$a = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-70f12bd4-5OMXKOAZ.js");
...
var loader$9 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-f2320105-CMKHRAEK.js");
...
var loader$8 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-587899a1-5HU5UNDB.js");
...
var loader$7 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-d93cdb3a-JBOM33OQ.js");
...
var loader$6 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-49397b02-UNLP6NIZ.js");
...
var loader$5 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-4a651766-KFZNEKX6.js");
...
var loader$4 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-85554ec2-EIXBOOJ5.js");
...
var loader$3 = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-fc14e90a-4MCIUOLQ.js");
...
var loader$2 = async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-04a897e0-L3I2FRAJ.js");
...
var loader$1 = async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-38ab4fdb-SYJI2HLP.js");
...
export {
  ...
  baseMerge_default,
  identity_default6 as identity_default,
  apply_default,
  overRest_default,
  constant_default12 as constant_default,
  shortOut_default,
  setToString_default,
  baseRest_default,
  isIterateeCall_default,
  createAssigner_default,
  merge_default3 as merge_default,
  baseKeys_default,
  Set_default,
  WeakMap_default,
  getTag_default,
...
mermaid/dist/mermaid-b5860b54.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5WRDZJBC.js.map
